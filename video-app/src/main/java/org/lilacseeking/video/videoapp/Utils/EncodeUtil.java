//package org.lilacseeking.course.videoapp.Utils;
//
//import com.alibaba.fastjson.JSON;
//import org.junit.jupiter.api.Test;
//import org.lilacseeking.course.videoapp.Common.ASycShowProcess;
//import org.lilacseeking.course.videoapp.Listener.EncodingListener;
//import org.lilacseeking.course.videoapp.Service.RedisService;
...
////        // 2 定义视频属性
////        VideoAttributes course = new VideoAttributes();
//////        course.setCodec("mpeg4");
//////        course.setBitRate(160000);
//////        course.setFrameRate(15);
//////        course.setSize(totalVideoSize);
////        // 2 定义音频属性
////        AudioAttributes audio = new AudioAttributes();
////        // 编码器名称，为空则复制文件
...
////        // 视频流编码属性
////        encodeAttr.setVideoAttributes(course);
////        // 音频流编码属性
//////        encodeAttr.setAudioAttributes(audio);
////        // 4 设置进度监听
...
////        } catch (EncoderException e) {
////            LOGGER.error("视频转码至mp4失败，源文件路径：{}，目标文件路径：{}，错误信息：{}，音频属性：{}，转码属性：{}",source.getPath(),target.getPath(),e.getMessage(),JSON.toJSONString(course),JSON.toJSONString(encodeAttr));
////        }
////    }
//
//    /**
...
//        assertTrue(result != null && result.length >0, "No course decoders found");
//    }
//
//    /**
//     * 获取视频编码器列表
...
//        assertTrue(result != null && result.length >0, "No course enecoders found");
//    }
//
//    /**
...
//        VideoAttributes course = new VideoAttributes();
////        course.setCodec("mpeg4");
////        course.setBitRate(31876000);
////        course.setFrameRate(15);
//        course.setSize(new VideoSize(1920,1080));
//        EncodingAttributes attrs = new EncodingAttributes();
//        attrs.setFormat("avi");
////        attrs.setAudioAttributes(audio);
//        attrs.setVideoAttributes(course);
//        Encoder encoder = new Encoder();
...
//////        course.setBitRate(160000);
//////        course.setFrameRate(15);
////        course.setSize(new VideoSize(3840, 2160));
////        EncodingAttributes attrs = new EncodingAttributes();
////        attrs.setFormat("avi");
////        attrs.setAudioAttributes(audio);
////        attrs.setVideoAttributes(course);
...
////        course.setBitRate(160000);
////        course.setFrameRate(15);
////        course.setSize(new VideoSize(176, 144));
////        EncodingAttributes attrs = new EncodingAttributes();
////        attrs.setFormat("3gp");
////        attrs.setAudioAttributes(audio);
////        attrs.setVideoAttributes(course);
...
//        course.setBitRate(160000);
//        course.setFrameRate(15);
//        course.setSize(new VideoSize(400, 300));
//        EncodingAttributes attrs = new EncodingAttributes();
//        attrs.setFormat("flv");
//        attrs.setAudioAttributes(audio);
//        attrs.setVideoAttributes(course);
...
//            VideoAttributes course = new VideoAttributes();
//            course.setCodec("mpeg4");
//            course.setBitRate(1500000);
//            course.setFrameRate(30);
//            course.setSize(new VideoSize(320, 240));
//            EncodingAttributes attrs = new EncodingAttributes();
//            attrs.setFormat("mp4");
//            attrs.setVideoAttributes(course);
//            attrs.setAudioAttributes(audio);
