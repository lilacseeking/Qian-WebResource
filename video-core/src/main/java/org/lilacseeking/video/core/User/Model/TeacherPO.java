package org.lilacseeking.video.core.User.Model;
...
public class TeacherPO extends BaseEntityPO {
     ...
     * 身份证文件名
     */
    @Column(name="id_card_file_name", nullable=false,length = 512)
     ...
     * 学历证书文件名
     */
    @Column(name="degree_file_name", nullable=false,length = 512)
    private String degreeFileName;

    /**
     * 研究方向
     */
    @Column(name="research_area", nullable=false,length = 256)
    ...
    private YesOrNoEnum verifyStatus = YesOrNoEnum.NULL;
